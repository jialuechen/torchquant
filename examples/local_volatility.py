import torch
from torchquantlib.models.local_volatility.dupire_local_volatility import DupireLocalVolatility
...
model = DupireLocalVolatility(spots, strikes, expiries, implied_vols)
